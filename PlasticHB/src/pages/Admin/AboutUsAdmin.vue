...
const saveStoreData = async () => {
  try {
    await axios.put(`http://localhost:3000/api/store/about_us/${storeData.value.id_store}`, {
      ...
      phone_number: storeData.value.phone_number,
      opening_hours: storeData.value.opening_hours
    })
...
<!--             
        ...
        <div v-else>
          ...
          <input v-model="storeData.address" class="edit-input" placeholder="Alamat Toko">
          <input v-model="storeData.phone_number" class="edit-input" placeholder="Nomor Telepon">
          <input v-model="storeData.opening_hours" class="edit-input" placeholder="Jam Buka">
        </div>
