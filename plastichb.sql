...
CREATE TABLE IF NOT EXISTS "cart" (
	...
	CONSTRAINT "cart_id_product_fkey" FOREIGN KEY ("id_product") REFERENCES "products" ("id_product") ON UPDATE NO ACTION ON DELETE NO ACTION,
	CONSTRAINT "cart_id_user_fkey" FOREIGN KEY ("id_user") REFERENCES "users" ("id_user") ON UPDATE NO ACTION ON DELETE NO ACTION
);

-- Dumping data for table public.cart: -1 rows
...
INSERT INTO "contact_messages" ("id_contact", "id_user", "message", "send_at") VALUES
	...
	(7, NULL, 'testing', '2025-08-10 13:11:04.786');
...
-- Dumping data for table public.order_items: -1 rows
...
INSERT INTO "products" ("id_product", "id_category", "name_product", "description", "price", "image_url") VALUES
	(1, 1, 'Botol', 'Botol plastik tahan panas, kapasitas 1 liter, warna biru', 15000, 'botol minum.jpg'),
...
INSERT INTO "users" ("id_user", "username", "email", "password", "image_profile", "balance") VALUES
	(1, 'admin', 'admin@gmail.com', 'admin123', 'template.jpg', 1000000.00),
